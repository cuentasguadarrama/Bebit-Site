...
BlogPostHeader8.defaultProps = {
  authorName: 'Equipo de Producción de Bebidas',
  blogPostImageSrc: 'https://play.teleporthq.io/static/svg/default-img.svg',
  rootClassName: '',
  blogPostImageAlt: 'Tecnología de punta en la producción de bebidas',
  blogPostTitle:
    'Descubre nuestra tecnología de punta en la producción de bebidas de alta calidad',
}
